# mastery-3-2-modularity - Mastery Module 3.2. Modularity

In this module we will serve a cataplana dish. Then we'll list all module dependencies in the resulting module.

Base project:

[mastery-3-2](../mastery-3-2/Readme.md)
