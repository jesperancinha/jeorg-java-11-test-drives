...
```bash
10:26 $ java --add-reads rocket=consolerizer --add-exports lunar.module/org.jesperancinha.java11.lunar.extra=rocket --module-path out --module rocket/org.jesperancinha.java11.rocket.RocketRunner rocket=lunar.module --module-path out --module rocket/org.jesperancinha.java11.rocket.RocketRunner
