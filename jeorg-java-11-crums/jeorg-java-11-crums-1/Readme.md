...
Crums are classes without a theme which are destined to highlight specific points of the Java Language. There is no context. The point is to make them as fast as possible and understand the nuances.
