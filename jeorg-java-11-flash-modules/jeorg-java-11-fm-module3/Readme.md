...
```bash
java --module-path modules:out --module ocpfmmodule3/org.jesperancinha.java11.flashmodule.module3.FlashModule3
java --module-path modules/consolerizer-1.0.0-SNAPSHOT.jar:out --module ocpfmmodule3/org.jesperancinha.java11.flashmodule.module3.FlashModule3
java -p modules:out --module ocpfmmodule3/org.jesperancinha.java11.flashmodule.module3.FlashModule3
