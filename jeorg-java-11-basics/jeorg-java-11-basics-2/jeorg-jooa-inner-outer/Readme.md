...
A culmination of inner and outer classes and public/default/protected/private scope studies.

We will be using data from [Peter Gabriel](https://en.wikipedia.org/wiki/Peter_Gabriel) 's [Sledgehammer](https://en.wikipedia.org/wiki/Sledgehammer_(Peter_Gabriel_song))

## Output

```text
//// Analysing our anonymous class of FruitCake
org.jesperancinha.java11.inner.outer.SledgeHammer$1@6b71769e
Instance of  SledgeHammer.FruitCake? true
--- baking fruit cage ---
org.jesperancinha.java11.inner.outer.SledgeHammer$1
Dates default constructor called!
//// Outside the package we cannot access number 1 hit dates org.jesperancinha.java11.inner.outer.canada.Dates@153f5a29
Dates default constructor called!
//// However with a subclass we can access the protected member for Canada 1986-07-21
Dates default constructor called!
//// Also, if we use a helper class within the package with a public method we can also access the date 1986-07-21
//// Creating CanadaDates using this
Dates default constructor called!
This is called!
I kicked the habit
//// Creating CanadaDates using super
...
<div align="center">
      <a href="https://www.youtube.com/watch?v=OJWJE0x7T4Q">
         <img 
              src="https://img.youtube.com/vi/OJWJE0x7T4Q/0.jpg" 
              style="width:10%;">
      </a>
</div>
