...
Let's see how labels work and how can we break loops with them. We will use  [Evil Numbers](https://en.wikipedia.org/wiki/Evil_number) as our data source. Let's not confuse this with the biblical numbers that "are evil".
