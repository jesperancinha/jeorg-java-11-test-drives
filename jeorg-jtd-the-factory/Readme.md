...
```bash
curl https://repo1.maven.org/maven2/org/jesperancinha/console/consolerizer/1.0.0/consolerizer-1.0.0.jar --output consolerizer-1.0.0.jar
unzip consolerizer-1.0.0.jar 
```
